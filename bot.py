    ...
    with st.sidebar:
        ...
        if web_search_enabled != st.session_state.web_search_enabled:
            ...
            if web_search_enabled:
                st.session_state.selected_models = default_reference_models.copy()
                st.session_state.selected_models.append("Qwen/Qwen2-72B-Instruct")  # Thêm mô hình Qwen/Qwen2-72B-Instruct
        ...
        with st.expander("Configuration", expanded=False):
            model = st.selectbox(
                ...
                default_reference_models,
                index=default_reference_models.index("Qwen/Qwen2-72B-Instruct") if st.session_state.web_search_enabled else 0
            )
